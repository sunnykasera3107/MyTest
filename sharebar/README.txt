...
2. Visit the settings page (3) to review the global settings.
...
KNOWN BUGS
-----------
1. Display options [less than 1000px ] horizontal sharebar is not visible.
2. While displaying out of content some creepy js issue.
